...
public class SettingStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarSettingStudent.setTitle(R.string.text_setting_student_title_toolbar);
        setSupportActionBar(toolbarSettingStudent);
        ActionBar actionBarSettingStudent = getSupportActionBar();
        actionBarSettingStudent.setDisplayHomeAsUpEnabled(true);
        actionBarSettingStudent.setHomeAsUpIndicator(R.drawable.ic_round_menu);
